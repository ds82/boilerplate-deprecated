/*
 ...
 License: MIT
*/
(function(){'use strict';function d(a){return function(){for(var c=arguments[0],b=1,c="["+(a?a+":":"")+c+"] http://errors.angularjs.org/1.2.25/"+(a?a+"/":"")+c;b<arguments.length;b++)c=c+(1==b?"?":"&")+"p"+(b-1)+"="+encodeURIComponent("function"==typeof arguments[b]?arguments[b].toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof arguments[b]?"undefined":"string"!=typeof arguments[b]?JSON.stringify(arguments[b]):arguments[b]);return Error(c)}}(function(a){var c=d("$injector"),b=d("ng");a=a.angular||
